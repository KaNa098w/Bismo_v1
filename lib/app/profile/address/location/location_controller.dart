import 'package:bismo/app/profile/address/location/location_view.dart' as mobile;
...
class LocationController extends StatelessController {
  ...
  Display view(BuildContext context) {
    ...
    return Display(
      title: _title,
      mobile: mobile.LocationView(title: _title),
    );
  }
}
